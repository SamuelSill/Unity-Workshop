...
namespace FreeDraw
{
    ...
    public class Drawable : MonoBehaviour
    {
        ...
        void Update()
        {
            ...
            Vector2 mouse_world_position = carRigidbody2D.position;
        ...
        //??????????????????????????????????????????????????????????????????????????????????????????????
        //??????????????????????????????????????????????????????????????????????????????????????????????
        public Color color_purpule = new Color(190, 0, 255);
        public Color color_orange = new Color(255, 150, 0);
        public Color mixColors(Color ground_color, Color car_color) {


            //if ((ground_color == Color.blue && car_color == Color.red) || (ground_color == Color.red && car_color == Color.blue) || ground_color == color_purpule) {
                //print("true");
            //    return color_purpule;
            //}
            //if ((ground_color == Color.red && ground_color == Color.yellow) || (ground_color == Color.yellow && ground_color == Color.red) || ground_color == color_orange)
           // {
            //    return color_orange;
            //}
            //if ((ground_color == Color.blue && car_color == Color.yellow) || (ground_color == Color.yellow && car_color == Color.blue) || ground_color == Color.green)
           // {
            //    return Color.green;
            //}
        ...
        public void MarkPixelToChange(int x, int y, Color color)
        {
            ...
            //if ((color == Color.red || color == Color.green)&& (cur_colors[array_pos] == Color.blue || cur_colors[array_pos] == Color.green))
                //color = Color.green;

            cur_colors[array_pos] = mixColors(cur_colors[array_pos], color);
        }
        ...
        public void ColourPixels(Vector2 center_pixel, int pen_thickness, Color color_of_pen)
        {
            ...
            if(drawable_texture.GetPixel(center_x, center_y) != Color.white)
